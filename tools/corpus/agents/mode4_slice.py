#!/usr/bin/env python3
"""slice_transcript.py adapter for dict-format pieces.json ({'segments': [...]})
whose segments carry explicit 'wav' names (1-indexed). Same slicing math as
tools/corpus/slice_transcript.py (pad 0.35, piece-local times).

Usage: mode4_slice.py <tape_transcript.json> <pieces_dir>
"""
import json, os, sys
