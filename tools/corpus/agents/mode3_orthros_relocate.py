#!/usr/bin/env python3
"""Re-run locate_tracks' fuzzy match for single mode3-orthros tracks inside a
restricted page window (used to re-anchor pieces that matched a duplicate
setting of the same text later in the book, breaking monotonic order).

Usage: mode3_orthros_relocate.py <piece.json> <p0> <p1>
Prints the best (page,line) range + match fraction inside the window.
"""
