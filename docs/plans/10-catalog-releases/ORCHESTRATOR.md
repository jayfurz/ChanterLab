...
Status: release-contract design ready; `BASE-00` completed at `e77ffa7`.
...
| Order | Plan | Status |
|---|---|---|
| 1 | [`11-release-contract.md`](11-release-contract.md) | ready after baseline |
| 2 | [`12-atomic-build-promote-rollback.md`](12-atomic-build-promote-rollback.md) | blocked on 11 |
